...
identification}
\author{L. Cilli\'{e}, 16010450, Supervisors: Prof. B.M. Herbst and Dr. S.J van der Walt}
...
\begin{figure}[H]
\centering
\mbox{\subfigure[Shark fin 1]{\includegraphics[width=2in]{haai1.jpg}} \quad
\subfigure[Shark fin 2]{\includegraphics[width=2in]{haai4.jpg}} \quad
\subfigure[Shark fin 3]{\includegraphics[width=2in]{haai2.jpg}}}
...
The DARWIN software package is well known when it comes to aquiring important data about Great White sharks.  It was initially implemented by undergraduate 
