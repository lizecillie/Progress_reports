...
For optimisational purposes, the Joblib\cite{joblib} software package is used. 
...
The procedure of identifying sharks can be
  ...
  Ms. T. Marais for her generous contribution to the developement of the pipeline.}, each implemented as part of
...
An alternative method needs to be investigated. \\
...
The function \texttt{fin\_detect()}, written as part of the pipeline, identifies the shark fin in an image.
...
The DTW implementation\footnote{I am indebted to
  Dr. S.J. van der Walt for providing us with a DTW implementation.} we use, only accomodates
...
of the fin, colour spaces other than the RGB colour space might prove to valuable when detecting edges.  \\
