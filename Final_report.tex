...
\begin{figure}[H]
 \centering
 \includegraphics[width=3in]{polyshark.jpg}
...
A distance matrix is calculated, containing the distance between
each pair of elements as entries.  We now view this matrix as a
grid, where the
...
\subfigure{\includegraphics[width=2in]{conway1.jpg}}} \caption{A well known pattern, called the Gosper Glider Gun \cite{n}, shown on the left and a more interesting pattern \cite{p} shown on the right.}
\end{figure}
