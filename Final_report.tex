...
measures such as the difference between intensity value and the region's mean.  Pixels are then
allocated to a specific region for which that difference is a minimum.  The process
