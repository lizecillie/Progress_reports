...
neighbourhood.  Two of the most common neighbourhood systems used are the Von
Neumann neighbourhood and the Moore neighbourhood which are shown below.
\note{vague.  What exactly??}  This rule
...
as that of its neighbourhood.  It is known that the
