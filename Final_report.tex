...
don't think.  Region merging is all about merging *regions*.  Don't understand??}
...
state gets updated.  Note that the rules for updating the state of each cell are the same and do not
...
This "game" is a zero-player game, i.e. it developes according to an initial state
and require now further input.
