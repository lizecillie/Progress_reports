...
The databasis consists of various shark fin images, taken on different dates and
from different locations.
Also note that not every image corresponds to a unique shark, i.e. the databasis
...
sentence. Why??}  For the investigation of various image processing algorithms,
...
identified as
"right", otherwise \note{scratch up to end of "as"}the orientation is identified
as "left". 
...
Gansbaai area by means of shark fin identification and matching.  They claim to have found approximately
...
\note{References to all of these--above and below!  I do that at the top where I introduce the section.}
...
\noindent It can be seen that the modified version gives better results around the edges, which is
essential in the case of the shark fin images. \\ 
...
random walker to see how they explained it.  Got this from the reference they gave there.}  In other words, if the user
