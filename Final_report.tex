...
\ref{segmentation}.  However, more success was achieved by rather reflecting the fin in the horisontal direction to ensure that all the shark fins have the
...
This function selects all points inside a given polygon.  These points are then set as the foreground and background pixels respectively.  
