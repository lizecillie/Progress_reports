...
Below we show a dummy sharkfin image where the orientation is detected using PCA.
...
This algorithm gives us the orientation of the sharkfin in terms of the direction in which the shark is swimming, as from the front, 
...
\begin{figure}[H]
 \centering
 \includegraphics[width=3in]{segmenation.jpg}
