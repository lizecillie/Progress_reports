...
At the moment the segmentation algorithm is taking a long time to execute.
This then slows down the whole process of identification.  Repeated calculations of the
