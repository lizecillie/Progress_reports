...
transformation to project the shorter sequence on top of the longer sequence such that they fit on top of each other
as best as possible, when viewed as a plotted path.  This is done by shifting the the starting points
of both sequences to the coordinate $(0, 0)$.
We then transform the endpoints to .
