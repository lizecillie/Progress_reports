...
compared with other fins.  We use the Sobel operator to identify the edge and ease further analysis.  The sobel operator applied to one of the 
sharkfin images is shown in \ref{sobel}.  Note that this operator only works on a grayscale image.
