...
\subfigure{\includegraphics[width=2in]{conway1.jpg}}} \caption{A well known pattern, called the Gosper Glider Gun, shown on the left and a more interesting pattern shown on the right.}
\end{figure}
