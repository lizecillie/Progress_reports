...
an immediate result was seen.  Since the borders
  were higher, it was less likely to cross them.  
  A
...
A request from a PhD student for assistance in her research project on identifying sharks led to the development of a pipeline. The Growcut algorithm wis used as the main segmentation algorithm. A workable pipeline is developed. \\
...
then be updated to include information about the sharks that can be valuable to marine biologists.  \\
