...
the less reliably the the path is tracked.\note{Actually--it's
...
Images such as the one below pose a challenge when finding the path defining the dorsal fin.
...
\noindent Here is a comparison between the result of the original algorithm on
