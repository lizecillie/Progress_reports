...
To ease further processesand analysis, we determine the orientation of the shark fin in the image.  
...
the data.  Suppose we have $K$ data points, $\mathbf{x}_k,$ for $k=1,2, \ldots ,K$. This is done by computing a covariance matrix, $C_{\mathbf{x}}$,
\[
...
This algorithm gives us the orientation of the shark fin in terms of the direction in which the shark is swimming, as from the front, 
